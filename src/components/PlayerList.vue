      ...
      <div class="col-12 col-xl-8 offset-xl-2 pt-5">
        ...
        <table class="table table-sm table-responsive table-hover table-striped align-middle">
          ...
          <tr v-for="({id, nickname, status, ranking}, index) in players" :key="id">
            ...
            <td>{{ ranking }}</td>
            <td v-if="edit === 1">
              <a href="javascript:void(0)" class="pe-2 text-info" title="Editar"><i class="fa-solid fa-user-pen"></i></a>
              <a href="javascript:void(0)" class="pe-2 text-danger" title="Eliminar"><i class="fa-solid fa-user-slash"></i></a>
            </td>
          </tr>
          </tbody>
        </table>
